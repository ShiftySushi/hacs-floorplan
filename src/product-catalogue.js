...
const products=[
  ...
  {id:'lg-g4-65-wall',name:'LG G4 65 inch — wall mount',type:'tv',width:1.441,depth:.0243,height:.826,colours:[['Silver / black','#444748']],source:lg,note:'Set wall mounting height.',variant:'wall'},
  {id:'lg-g4-65-stand',name:'LG G4 65 inch — with stand',type:'tv',width:1.441,depth:.263,height:.91,colours:[['Silver / black','#444748']],source:lg,note:'Place at bench height.',variant:'stand'},
  ...
  {id:'billy-extension-80',name:'IKEA BILLY 80 cm with top extension',type:'bookshelf',width:.8,depth:.28,height:2.37,colours:[white,oak,['Black oak effect','#39352e'],['Walnut effect','#826344']],source:u1+'billy-bookcase-white-s59182201/',note:'No doors.'},
