...
const products=[
  ...
  {id:'lg-g4-65-wall',name:'LG G4 65 inch — wall mount',type:'tv',width:1.441,depth:.0243,height:.826,colours:[['Silver / black','#444748']],source:'https://www.lg.com/uk/tvs-soundbars/oled-evo/oled65g46ls/',note:'Without stand; set mounting height above floor.',variant:'wall'},
  {id:'lg-g4-65-stand',name:'LG G4 65 inch — with stand',type:'tv',width:1.441,depth:.263,height:.91,colours:[['Silver / black','#444748']],source:'https://www.lg.com/uk/tvs-soundbars/oled-evo/oled65g46ls/',note:'High stand; place at bench height.',variant:'stand'},
  ...
  {id:'govee-h7075',name:'Govee H7075 outdoor wall light',type:'wall_light',width:.131,depth:.062,height:.263,colours:[black],source:'https://uk.govee.com/products/govee-outdoor-wall-light',note:'Editable mounting height.'},
