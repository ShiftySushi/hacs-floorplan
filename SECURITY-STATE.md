...
Initial baseline: Forgejo run 1507 (Actions run 56), SHA `0533375d555eb8e007e63155a03ae8b4bda66f32`, artefact 499, scanned 15 September 2026. The npm lockfile result contains 31 packages and zero recorded vulnerability occurrences; secret and configuration counts are also zero. The same head's GitHub security job passed. This does not extend coverage to private assets or a live Home Assistant instance. Owner `shiftysushi` should review those coverage boundaries by 29 September 2026. Future findings retain identifier, version, target, candidate fixed version or no recorded fix, unknown applicability, owner, next action and a 14-day review date. No open Forgejo Renovate PR existed at the initial inspection.
