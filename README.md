...
4. **Entities:** search for a light, sensor or binary sensor and tap its position. Select a marker to reposition it, or adjust its coordinates. The editor can place assigned room lights automatically for you to fine-tune.
