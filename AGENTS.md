...
- The public `/demo/` uses temporary fictional configuration. The optional private `/floorplans/demo.html` persists scene edits in browser local storage; preserve it during validation. Portable scene exports contain images and entity IDs and must remain private.
